...
const BRAND_PHOTOS: Record<string, string[]> = {
  ...
  bmw:             ["photo-1594051673969-172a6f721d3c","photo-1555215695-3004980ad54e"],
...
function getBrandPhoto(brand: string, model: string): string {
  ...
  const photos = BRAND_PHOTOS[b] ?? BRAND_PHOTOS[b.split(/[\s-]/)[0]] ?? [
    "photo-1621007947382-bb3c3994e3fb","photo-1594051673969-172a6f721d3c",
    "photo-1560958089-b8a1929cea89","photo-1584060622420-0673aad46076","photo-1614484393797-257ee1d83a1e",
  ]
