...
export const ownerReviews: Record<string, OwnerReview[]> = {
  ...
  "kia-ev6-2024": [
    { name: "Megan T.", location: "Atlanta, GA", rating: 5, title: "800V charging is the feature nobody talks about enough", review: "I added 180 miles in 18 minutes at an Electrify America station. That's it. That's the feature that sold me. Add in gorgeous looks and a fun AWD setup — this car is absurdly good.", owned: "Owned 14 months" },
    { name: "Joel S.", location: "San Francisco, CA", rating: 5, title: "Switched from Model Y and don't miss it", review: "Better designed interior, physical climate controls, and Kia's UVO app actually works. Range is slightly less than the Model Y Long Range but the charging speed more than makes up for it.", owned: "Owned 11 months" },
    { name: "Amy C.", location: "Boston, MA", rating: 4, title: "Stunning car with a minor range caveat", review: "Love every drive in this car. 274 miles real-world range is fine for my use. One wish: a slightly bigger battery for anxiety-free winter road trips. Everything else is 10/10.", owned: "Owned 9 months" },
  ],
  "mercedes-glc-2024": [
